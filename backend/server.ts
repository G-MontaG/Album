...
class Server {
  ...
  constructor() {
    ...
    this.app.get(new RegExp(`^\/(login|signup|signup\/local|google-auth\/response|facebook-auth\/response|verify|forgot|reset|dashboard)\/?$`), function (req:express.Request, res:express.Response) {
